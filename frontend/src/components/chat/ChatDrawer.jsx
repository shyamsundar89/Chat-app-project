...
const ChatDrawer = ({ children, isOpen, setIsOpen }) => {
  return (
    <main
    ...
    >
      <section
        className={`w-64 left-0 absolute bg-white dark:bg-gray-800 h-full shadow-xl transition-all transform duration-300 ${
      ...
      >
        <article className="relative h-full flex flex-col">
          ...
          <Link to="/">
            <h1 className="text-2xl text-gray-900 dark:text-gray-100 py-[6.4px] font-bold text-center italic">
              ChatApp
            </h1>
          </Link>
            <XMarkIcon
